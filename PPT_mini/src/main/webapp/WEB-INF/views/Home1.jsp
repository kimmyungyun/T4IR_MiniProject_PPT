...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#Deadmodal1">
  ...
  <!-- Modal 1 -->
  <div class="portfolio-modal modal fade" id="Deadmodal1" tabindex="-1" role="dialog" aria-hidden="true">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body" style="height: 650px;">
                ...
                <iframe src="/Dmodal.html#dmodal1" id="Dm1" style="width: 100%; height: 100%; border: 0px;"></iframe>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                <!-- Project Details Go Here -->
                <iframe src="/Dmodal.html#dmodal2" id="Dm2" style="width: 100%; height: 100%; border: 0px;"></iframe>
                <button class="btn btn-primary" data-dismiss="modal" type="button">
                  <i class="fas fa-times"></i>
                  Close Project</button>
              </div>
